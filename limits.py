...
if dothetafile:
  ...
  for bt in bt_cat:
    ...
    for isgn in range(len(process_namelist)):
      ...
      limitfile.cd()
      pdftmpup.Write(htnamebase+bt+uu+theta_signal[isgn]+uu+'pdf__plus')
      pdftmpdown.Write(htnamebase+bt+uu+theta_signal[isgn]+uu+'pdf__minus')
      mjpdftmpup.Write(mjnamebase+bt+uu+theta_signal[isgn]+uu+'pdf__plus')
      mjpdftmpdown.Write(mjnamebase+bt+uu+theta_signal[isgn]+uu+'pdf__minus')
